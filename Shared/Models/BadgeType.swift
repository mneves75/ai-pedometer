...
enum BadgeType: String, Codable, CaseIterable, Sendable {
    ...
    var localizedTitle: String {
        switch self {
        case .steps5K: L10n.localized("5K Steps", comment: "Badge title for 5000 steps achievement")
        case .steps10K: L10n.localized("10K Steps", comment: "Badge title for 10000 steps achievement")
        case .steps15K: L10n.localized("15K Steps", comment: "Badge title for 15000 steps achievement")
        case .steps20K: L10n.localized("20K Steps", comment: "Badge title for 20000 steps achievement")
        case .steps25K: L10n.localized("25K Steps", comment: "Badge title for 25000 steps achievement")
        case .streak3: L10n.localized("3-Day Streak", comment: "Badge title for 3 day goal streak")
        case .streak7: L10n.localized("Week Warrior", comment: "Badge title for 7 day goal streak")
        case .streak14: L10n.localized("Two Week Champion", comment: "Badge title for 14 day goal streak")
        case .streak30: L10n.localized("Monthly Master", comment: "Badge title for 30 day goal streak")
        case .streak100: L10n.localized("Century Club", comment: "Badge title for 100 day goal streak")
        case .streak365: L10n.localized("Year of Excellence", comment: "Badge title for 365 day goal streak")
        case .distance5km: L10n.localized("5K Distance", comment: "Badge title for 5km total distance")
        case .distance10km: L10n.localized("10K Distance", comment: "Badge title for 10km total distance")
        case .distanceMarathon: L10n.localized("Marathoner", comment: "Badge title for marathon distance")
        case .monthlyChallenge: L10n.localized("Monthly Challenge", comment: "Badge title for monthly challenge completion")
        }
    }
