...
- **1.0.8 (68) is in TestFlight** (2026-09-26): English lengths keep a space before the unit
  (`MeasurementFormatter` `.medium`). Build `0e24ed69` `VALID`, Internal Testers, IPA SHA-256
  `6904c89e…6d46` from a clean `git archive` of `e935362` (Xcode 27.0), CI green, tag `v1.0.8-beta4`.
  67 stays in App Review; 68 is TestFlight only.
