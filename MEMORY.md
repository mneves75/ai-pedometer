...
- **1.0.8 (68) source** (2026-09-25): English lengths keep a space before the unit (`MeasurementFormatter`
  `.medium`); build 68 goes to TestFlight only while 67 stays in App Review.
