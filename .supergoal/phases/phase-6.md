...
- Repo: ~/dev/PROJETOS_MOBILE/ai-pedometer. Swift 6.2 strict concurrency, warnings-as-errors; unit tests use Swift Testing; UI tests use XCUITest (16 tests today in `AIPedometerUITests/AIPedometerUITests.swift`).
