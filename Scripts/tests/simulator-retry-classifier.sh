...
if ! /bin/bash "${ROOT_DIR}/Scripts/simulator-retry-classifier.sh" "${TMP_DIR}/transient.log"; then
...
if /bin/bash "${ROOT_DIR}/Scripts/simulator-retry-classifier.sh" "${TMP_DIR}/functional.log"; then
