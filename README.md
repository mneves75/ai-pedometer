...
```bash
asc validate --app "<APP_ID_ASC>" --version "1.0.3" --platform IOS --output table
...
**Current source**: 1.0.3 (59). Source version does not indicate TestFlight or App Store availability. Production delivery is currently blocked on an Apple (`appl_`) RevenueCat key — see CHANGELOG 1.0.
